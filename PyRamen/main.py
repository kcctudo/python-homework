...
menu_filepath = Path('/Users/hannahtudo/UofT/python-homework/PyRamen/menu_data.csv')
sales_filepath = Path('/Users/hannahtudo/UofT/python-homework/PyRamen/sales_data.csv')
